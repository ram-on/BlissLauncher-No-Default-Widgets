...
public class AdaptiveIconCompat extends Drawable implements Drawable.Callback {
    ...
    private static final String path = "M142,180H38c-21,0 -38,-17 -38,-38V38C0,17 17,0 38,0h104c21,0 38,17 38,38v104C180,163 163,180 142,180z";
     ...
     */
    AdaptiveIconCompat(LayerState state, Resources res) {
        initReflections();
     ...
     */
    private void inflateLayers(Resources r, XmlPullParser parser,
                               AttributeSet attrs, Theme theme)
            throws XmlPullParserException, IOException {
        final LayerState state = mLayerState;
    ...
    protected static TypedArray obtainAttributes(Resources res,
                                                 Theme theme, AttributeSet set, int[] attrs) {
        if (theme == null) {
    ...
    static class ChildDrawable {
        ...
        ChildDrawable(ChildDrawable orig, AdaptiveIconCompat owner,
                      Resources res) {
    ...
    static class LayerState extends ConstantState {
        ...
        LayerState(LayerState orig, AdaptiveIconCompat owner,
                   Resources res) {
