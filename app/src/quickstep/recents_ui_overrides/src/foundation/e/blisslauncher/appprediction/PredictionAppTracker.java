...
import static com.android.blisslauncher.InvariantDeviceProfile.CHANGE_FLAG_GRID;
...
import com.android.blisslauncher.util.UiThreadHelper;
...
public class PredictionAppTracker extends AppLaunchTracker {
    ...
    @WorkerThread
    private AppPredictor createPredictor(PredictionUiStateManager.Client client, int count) {
    ...
    private boolean handleMessage(Message msg) {
        switch (msg.what) {
            case MSG_INIT: {
                ...
                mHomeAppPredictor = createPredictor(PredictionUiStateManager.Client.HOME, count);
                mRecentsOverviewPredictor = createPredictor(PredictionUiStateManager.Client.OVERVIEW, count);
                return true;
            }
            case MSG_DESTROY: {
                destroy();
            ...
            case MSG_PREDICT: {
                if (mHomeAppPredictor != null) {
                    ...
                    if (PredictionUiStateManager.Client.HOME.id.equals(client)) {
    ...
    public void onReturnedToHome() {
        String client = PredictionUiStateManager.Client.HOME.id;
