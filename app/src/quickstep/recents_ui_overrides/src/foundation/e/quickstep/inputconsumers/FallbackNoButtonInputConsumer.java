 ...
 */
package foundation.e.quickstep.inputconsumers;
...
import static foundation.e.quickstep.inputconsumers.OtherActivityInputConsumer.QUICKSTEP_TOUCH_SLOP_RATIO;
...
import foundation.e.quickstep.OverviewComponentObserver;
import foundation.e.quickstep.WindowTransformSwipeHandler;
import foundation.e.quickstep.util.ClipAnimationHelper;
import foundation.e.quickstep.util.NavBarPosition;
import foundation.e.quickstep.util.RecentsAnimationListenerSet;
import foundation.e.quickstep.util.SwipeAnimationTargetSet;
import foundation.e.quickstep.SwipeSharedState;
