...
import foundation.e.quickstep.SysUINavigationMode.NavigationModeChangeListener;
import foundation.e.quickstep.inputconsumers.AccessibilityInputConsumer;
import foundation.e.quickstep.inputconsumers.AssistantTouchConsumer;
import foundation.e.quickstep.inputconsumers.DeviceLockedInputConsumer;
import foundation.e.quickstep.inputconsumers.FallbackNoButtonInputConsumer;
import foundation.e.quickstep.inputconsumers.InputConsumer;
import foundation.e.quickstep.inputconsumers.OtherActivityInputConsumer;
import foundation.e.quickstep.inputconsumers.OverviewInputConsumer;
import foundation.e.quickstep.inputconsumers.OverviewWithoutFocusInputConsumer;
import foundation.e.quickstep.inputconsumers.ResetGestureInputConsumer;
import foundation.e.quickstep.inputconsumers.ScreenPinnedInputConsumer;
