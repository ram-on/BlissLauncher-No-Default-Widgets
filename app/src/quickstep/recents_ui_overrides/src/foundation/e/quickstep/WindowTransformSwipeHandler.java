...
import static com.android.blisslauncher.BaseActivity.INVISIBLE_BY_STATE_HANDLER;
import static com.android.blisslauncher.BaseActivity.STATE_HANDLER_INVISIBILITY_FLAGS;
import static com.android.blisslauncher.Utilities.SINGLE_FRAME_MS;
import static com.android.blisslauncher.Utilities.postAsyncCallback;
import static com.android.blisslauncher.anim.Interpolators.ACCEL_1_5;
import static com.android.blisslauncher.anim.Interpolators.DEACCEL;
...
import static com.android.blisslauncher.config.FeatureFlags.ENABLE_QUICKSTEP_LIVE_TILE;
import static com.android.blisslauncher.config.FeatureFlags.QUICKSTEP_SPRINGS;
import static com.android.blisslauncher.util.RaceConditionTracker.ENTER;
import static com.android.blisslauncher.util.RaceConditionTracker.EXIT;
import static com.android.blisslauncher.util.SystemUiController.UI_STATE_OVERVIEW;
import static com.android.blisslauncher.views.FloatingIconView.SHAPE_PROGRESS_DURATION;
import static foundation.e.quickstep.ActivityControlHelper.AnimationFactory.ShelfAnimState.HIDE;
import static foundation.e.quickstep.ActivityControlHelper.AnimationFactory.ShelfAnimState.PEEK;
import static foundation.e.quickstep.MultiStateCallback.DEBUG_STATES;
import static foundation.e.quickstep.TouchInteractionService.MAIN_THREAD_EXECUTOR;
import static foundation.e.quickstep.TouchInteractionService.TOUCH_INTERACTION_LOG;
import static foundation.e.quickstep.WindowTransformSwipeHandler.GestureEndTarget.HOME;
import static foundation.e.quickstep.WindowTransformSwipeHandler.GestureEndTarget.LAST_TASK;
import static foundation.e.quickstep.WindowTransformSwipeHandler.GestureEndTarget.NEW_TASK;
import static foundation.e.quickstep.WindowTransformSwipeHandler.GestureEndTarget.RECENTS;
...
import com.android.blisslauncher.BaseDraggingActivity;
import com.android.blisslauncher.DeviceProfile;
import com.android.blisslauncher.InvariantDeviceProfile;
import com.android.blisslauncher.R;
import com.android.blisslauncher.Utilities;
import com.android.blisslauncher.anim.AnimationSuccessListener;
import com.android.blisslauncher.anim.AnimatorPlaybackController;
import com.android.blisslauncher.anim.Interpolators;
import com.android.blisslauncher.graphics.RotationMode;
import com.android.blisslauncher.logging.UserEventDispatcher;
import com.android.blisslauncher.testing.TestProtocol;
...
import com.android.blisslauncher.userevent.nano.LauncherLogProto.ContainerType;
import com.android.blisslauncher.util.RaceConditionTracker;
import com.android.blisslauncher.util.TraceHelper;
import com.android.blisslauncher.views.FloatingIconView;

import foundation.e.quickstep.ActivityControlHelper.ActivityInitListener;
import foundation.e.quickstep.ActivityControlHelper.AnimationFactory;
import foundation.e.quickstep.ActivityControlHelper.AnimationFactory.ShelfAnimState;
import foundation.e.quickstep.ActivityControlHelper.HomeAnimationFactory;
import foundation.e.quickstep.SysUINavigationMode.Mode;
import foundation.e.quickstep.inputconsumers.InputConsumer;
import foundation.e.quickstep.inputconsumers.OverviewInputConsumer;
import foundation.e.quickstep.util.ClipAnimationHelper;
import foundation.e.quickstep.util.RectFSpringAnim;
import foundation.e.quickstep.util.RemoteAnimationTargetSet;
import foundation.e.quickstep.util.SwipeAnimationTargetSet;
import foundation.e.quickstep.views.LiveTileOverlay;
