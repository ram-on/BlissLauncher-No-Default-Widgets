...
public class DeepShortcutView extends FrameLayout {
    ...
    private IconTextView mBubbleText;
    private View mIconView;
    private View mDivider;

    private ShortcutItem mInfo;
    ...
    public IconTextView getBubbleText() {
        return mBubbleText;
    }
     ...
     */
    /*public ShortcutItem getFinalInfo() {
        final ShortcutItem badged = new ShortcutItem(mInfo);
