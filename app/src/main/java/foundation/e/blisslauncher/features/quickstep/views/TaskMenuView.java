...
public class TaskMenuView extends AbstractFloatingView {
    ...
    private void addMenuOptions(TaskView taskView) {
        ...
        for (TaskSystemShortcut menuOption : MENU_OPTIONS) {
            View.OnClickListener onClickListener = menuOption.getOnClickListener(mActivity, taskView);
    ...
    private void addMenuOption(TaskSystemShortcut menuOption, View.OnClickListener onClickListener) {
