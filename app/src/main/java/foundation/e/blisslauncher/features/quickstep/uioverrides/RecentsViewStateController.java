...
import static foundation.e.blisslauncher.features.quickstep.QuickScrubController.QUICK_SCRUB_START_INTERPOLATOR;
import static foundation.e.blisslauncher.features.quickstep.QuickScrubController.QUICK_SCRUB_TRANSLATION_Y_FACTOR;
import static foundation.e.blisslauncher.features.quickstep.views.LauncherRecentsView.TRANSLATION_Y_FACTOR;
import static foundation.e.blisslauncher.features.quickstep.views.RecentsViewContainer.CONTENT_ALPHA;
...
import foundation.e.blisslauncher.features.quickstep.views.LauncherRecentsView;
