...
public class DragView extends View {
     ...
     */
    public DragView(TestActivity launcher, Bitmap bitmap, int registrationX, int registrationY,
            ...
            public void run() {
                ...
                if (dr instanceof AdaptiveIconDrawable) {
                    ...
                    mTranslateX = new SpringFloatValue(
                        com.android.launcher3.dragndrop.DragView.this,
    ...
    public void remove() {
        if (getParent() != null) {
            mDragLayer.removeView(com.android.launcher3.dragndrop.DragView.this);
        }
    }
