...
open class InvariantDeviceProfile {
    ...
    var landscapeProfile: DeviceProfile? = null
    var portraitProfile: DeviceProfile? = null
    var defaultWallpaperSize: Point? = null
    ...
    constructor(context: Context) {
        ...
        defaultWallpaperSize = if (context.resources.configuration.smallestScreenWidthDp >= 720) {
            Point(
                (largeSide * wallpaperTravelToScreenWidthRatio(
                    largeSide,
                    smallSide
                )).toInt(),
                largeSide
            ...
            Point(Math.max(smallSide * 2, largeSide), largeSide)
        }
    }
